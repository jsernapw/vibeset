...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-60 outline-none hover:opacity-100 focus-visible:ring-2 focus-visible:ring-neutral-400">
        <X className="h-4 w-4" />
